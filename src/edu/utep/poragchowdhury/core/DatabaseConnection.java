...
public class DatabaseConnection {
    ...
    public DatabaseConnection(String dbName) {
        ...
        try {
            ...
            this.con = DriverManager.getConnection(databaseURL + databasePort + databaseName, databaseUser, databasePassword);
    ...
    public void createTable(String tableName) throws Exception {
        String createTable = "CREATE TABLE IF NOT EXISTS " + tableName + " (id INT NOT NULL AUTO_INCREMENT, qvalue DOUBLE NOT NULL, PRIMARY KEY ( id ));";
